...
#define __PYX_HAVE__anms__ssc
#define __PYX_HAVE_API__anms__ssc
/* Early includes */
#include <math.h>
#include "ios"
#include "new"
...
/* Module declarations from 'anms.ssc' */
...
int __pyx_module_is_main_anms__ssc = 0;

/* Implementation of 'anms.ssc' */
...
static const char __pyx_k_target_num_kpts[] = "target_num_kpts";
...
static const char __pyx_k_keypoints_and_responses_must_ha[] = "`keypoints` and `responses` must have equal length along 0-th dimension. Provided lengths: keypoints=";
static const char __pyx_k_keypoints_must_be_a_2_dim_array[] = "`keypoints` must be a 2-dim array of shape (*, 2). Provided shape: ";
static const char __pyx_k_responses_must_be_a_1_dim_array[] = "`responses` must be a 1-dim array. Provided number of dim: ";
static const char __pyx_k_target_num_keypoints_must_lie_i[] = "`target_num_keypoints` must lie in the interval [1, keypoints.shape[0]-1]";
static const char __pyx_k_width_and_height_must_be_positi[] = "`width` and `height` must be positive integers";
...
static PyObject *__pyx_kp_u_keypoints_and_responses_must_ha;
static PyObject *__pyx_kp_u_keypoints_must_be_a_2_dim_array;
...
static PyObject *__pyx_kp_u_responses_must_be_a_1_dim_array;
...
static PyObject *__pyx_kp_u_target_num_keypoints_must_lie_i;
static PyObject *__pyx_n_s_target_num_kpts;
...
static PyObject *__pyx_f_4anms_3ssc__square_covering_adaptive_nms(__Pyx_memviewslice __pyx_v_keypoints, __Pyx_memviewslice __pyx_v_responses, Py_ssize_t __pyx_v_width, Py_ssize_t __pyx_v_height, Py_ssize_t __pyx_v_target_num_kpts, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  double __pyx_v_high;
  double __pyx_v_mid;
  Py_ssize_t __pyx_v_current_num_kpts;
  Py_ssize_t __pyx_v_i;
  unsigned char __pyx_v_complete;
 ...
 * 
 */
  __pyx_t_7 = (__pyx_v_responses.shape[0]);
  __pyx_t_8 = __pyx_t_7;
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_responses.shape[0];
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_neg_responses.shape[0];
 ...
 */
    ...
    Py_ssize_t __pyx_tmp_stride = __pyx_v_keypoints.strides[0];
        if (__pyx_tmp_idx < 0)
...
__pyx_t_6.data = __pyx_v_selected_keypoints.data;
    ...
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_selected_keypoints.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_selected_keypoints.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (unlikely(!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape))) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_t_6.shape[0] = __pyx_v_selected_keypoints.shape[1];
...
static std::vector<Py_ssize_t>  __pyx_f_4anms_3ssc__square_covering_nms(__Pyx_memviewslice __pyx_v_keypoints, __Pyx_memviewslice __pyx_v_priority_idxs, size_t __pyx_v_width, size_t __pyx_v_height, double __pyx_v_window_radius) {
  Py_ssize_t __pyx_v_i;
  double __pyx_v_grid_res;
  Py_ssize_t __pyx_v_num_cell_cols;
  Py_ssize_t __pyx_v_num_cell_rows;
  __Pyx_memviewslice __pyx_v_covered_grid = { 0, 0, { 0 }, { 0 }, { 0 } };
  std::vector<Py_ssize_t>  __pyx_v_result_kpts_idx;
  Py_ssize_t __pyx_v_idx;
  Py_ssize_t __pyx_v_row;
  Py_ssize_t __pyx_v_col;
  Py_ssize_t __pyx_v_row_min;
  Py_ssize_t __pyx_v_row_max;
  Py_ssize_t __pyx_v_col_min;
  Py_ssize_t __pyx_v_col_max;
 ...
 */
  __pyx_t_7 = (__pyx_v_keypoints.shape[0]);
  __pyx_t_8 = __pyx_t_7;
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_i = __pyx_t_9;
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_priority_idxs.shape[0];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_11 = 0;
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_keypoints.shape[0];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_10 >= __pyx_v_keypoints.shape[0])) __pyx_t_11 = 0;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_keypoints.shape[1];
 ...
 */
    ...
    if (__pyx_t_12 < 0) {
      ...
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_keypoints.shape[0])) __pyx_t_11 = 0;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_keypoints.shape[1];
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_covered_grid.shape[0];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_10 >= __pyx_v_covered_grid.shape[0])) __pyx_t_11 = 0;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_covered_grid.shape[1];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_11 = 1;
 ...
 *             col_min = max(col - 2, 0)
 */
      __pyx_t_17 = (__pyx_v_num_cell_rows - 1);
      __pyx_t_16 = (__pyx_v_row + 2);
 ...
 */
      __pyx_t_17 = (__pyx_v_num_cell_cols - 1);
      __pyx_t_18 = (__pyx_v_col + 2);
 ...
 */
      __pyx_t_6.data = __pyx_v_covered_grid.data;
      __pyx_t_6.memview = __pyx_v_covered_grid.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_6, 0);
      __pyx_t_11 = -1;
      if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_6,
    __pyx_v_covered_grid.shape[0], __pyx_v_covered_grid.strides[0], __pyx_v_covered_grid.suboffsets[0],
    0,
    0,
    &__pyx_t_11,
    __pyx_v_row_min,
...
if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_6,
    __pyx_v_covered_grid.shape[1], __pyx_v_covered_grid.strides[1], __pyx_v_covered_grid.suboffsets[1],
    1,
    1,
    &__pyx_t_11,
    __pyx_v_col_min,
          ...
          unsigned char __pyx_temp_scalar = 1;
          {
              ...
              for (__pyx_temp_idx_0 = 0; __pyx_temp_idx_0 < __pyx_temp_extent_0; __pyx_temp_idx_0++) {
                ...
                for (__pyx_temp_idx_1 = 0; __pyx_temp_idx_1 < __pyx_temp_extent_1; __pyx_temp_idx_1++) {
                  *((unsigned char *) __pyx_temp_pointer_1) = __pyx_temp_scalar;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __PYX_XDEC_MEMVIEW(&__pyx_t_6, 1);
  __Pyx_WriteUnraisable("anms.ssc._square_covering_nms", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_covered_grid, 1);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static double __pyx_f_4anms_3ssc__adaptive_nms_upper_bound(Py_ssize_t __pyx_v_width, Py_ssize_t __pyx_v_height, Py_ssize_t __pyx_v_target_num_kpts) {
  double __pyx_v_exp1;
  double __pyx_v_exp2;
  double __pyx_v_exp3;
  double __pyx_v_exp4;
 ...
 *     return sol
 */
  __pyx_t_1 = (__pyx_v_exp1 - __pyx_v_exp3);
  if (unlikely(__pyx_v_exp4 == 0)) {
    #ifdef WITH_THREAD
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "anms.ssc._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"square_covering_adaptive_nms", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4anms_3ssc_1square_covering_adaptive_nms, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4anms_3ssc_square_covering_adaptive_nms},
  {"_square_covering_adaptive_nms", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4anms_3ssc_3_square_covering_adaptive_nms, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4anms_3ssc_2_square_covering_adaptive_nms},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_ssc(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ssc},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_keypoints_and_responses_must_ha, __pyx_k_keypoints_and_responses_must_ha, sizeof(__pyx_k_keypoints_and_responses_must_ha), 0, 1, 0, 0},
  {&__pyx_kp_u_keypoints_must_be_a_2_dim_array, __pyx_k_keypoints_must_be_a_2_dim_array, sizeof(__pyx_k_keypoints_must_be_a_2_dim_array), 0, 1, 0, 0},
  ...
  {&__pyx_kp_u_responses_must_be_a_1_dim_array, __pyx_k_responses_must_be_a_1_dim_array, sizeof(__pyx_k_responses_must_be_a_1_dim_array), 0, 1, 0, 0},
  ...
  {&__pyx_kp_u_target_num_keypoints_must_lie_i, __pyx_k_target_num_keypoints_must_lie_i, sizeof(__pyx_k_target_num_keypoints_must_lie_i), 0, 1, 0, 0},
  {&__pyx_n_s_target_num_kpts, __pyx_k_target_num_kpts, sizeof(__pyx_k_target_num_kpts), 0, 0, 1, 1},
  ...
  {&__pyx_kp_u_width_and_height_must_be_positi, __pyx_k_width_and_height_must_be_positi, sizeof(__pyx_k_width_and_height_must_be_positi), 0, 1, 0, 0},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initssc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initssc(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_ssc(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ssc(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ssc(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ssc' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_ssc(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ssc", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_anms__ssc) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "anms.ssc")) {
      if (unlikely(PyDict_SetItemString(modules, "anms.ssc", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init anms.ssc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init anms.ssc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
